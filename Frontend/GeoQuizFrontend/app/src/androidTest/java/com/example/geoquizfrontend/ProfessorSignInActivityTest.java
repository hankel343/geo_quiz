...
public class ProfessorSignInActivityTest {
    ...
    @Before
    public void setup() {
        ActivityScenario.launch(ProfessorSignInActivity.class);
    }

    @Test
    public void testProfessorSignInActivityLaunchesSuccessfully() {
...
//        intended(hasComponent(ProfessorAccountCreation.class.getName()));
//        Intents.release();
    }
}
